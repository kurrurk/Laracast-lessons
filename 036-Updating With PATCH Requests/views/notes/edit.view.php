    ...
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        ...
        <form method="post" action="/note">
            ...
            <div class="mt-6 flex items-center justify-end gap-x-6">
                <a href="/note?id=<?= $note['id']; ?>" type="button" class="text-sm font-semibold leading-6 text-gray-900">Abrechen</a>
                <button type="submit" class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Aktualisieren</button>
            </div>
        </form>
