...
--
-- Host: localhost:3306
-- Erstellungszeit: 21. Mai 2024 um 00:54
...
(8, 'Ich lerne weiterhin PHP', 1),
(9, 'Work on <strong class=\"text-red-500 font-bold\"> something </strong>', 1),
(10, '<h1 style=\"font-size:100px\" >Ah ah ah ...</h1><script>alert(\'Hi,from JS\');</script>', 1);
