...
<main>
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Für ein neues Konto registrieren</h2>
        </div>
                ...
                <div>
                    ...
                    <?php if (isset($errors['email'])) : ?>
                        ...
                        <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 mt-10 rounded relative" role="alert">
                            ...
                            <span class="block sm:inline ml-10"><?= $errors['email']; ?></span>
                        </div>
                ...
                <div>
                    ...
                    <?php if (isset($errors['password'])) : ?>
                        ...
                        <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 mt-10 rounded relative" role="alert">
                            ...
                            <span class="block sm:inline ml-10"><?= $errors['password']; ?></span>
                        </div>
