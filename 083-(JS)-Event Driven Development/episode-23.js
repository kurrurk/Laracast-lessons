...
class Game {
    ...
    constructor ({minRange = 1, maxRange = 10, maxAttempts = 4, allowDuplicateGuesses = false} = {} ) {
    ...
    play( ) {
        ...
        if ( this.#result[0] !== 'cancel') {
            ...
            if ( this.#result[0] ) {
                return (`Game Over! The number is ${this.secretNumber}, and you guessed it, in ${this.#result[1]} attemts.`);
            } else {
